...
function parseArgs(argv) {
    const args = { login: "", theme: "light", cycle: 30, mower: "push", stripes: true, demo: false };
    ...
    for (let i = 0; i < argv.length; i++) {
        ...
        switch (a) {
            ...
            case "--theme": {
                ...
                if (t !== "light" && t !== "dark")
                    throw new Error(`--theme must be light or dark, got "${t}"`);
                args.theme = t;
                i++;
                break;
            }
            case "--cycle": {
                ...
                if (!(c > 0))
                    throw new Error("--cycle must be a positive number of seconds");
                args.cycle = c;
                i++;
                break;
            }
